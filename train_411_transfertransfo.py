...
def train():
    ...
    parser.add_argument("--model_checkpoint", type=str, default="gpt", help="Path, url or short name of the model")
    ...
    def update(engine, batch):
        ...
        loss = (output_gpt.loss * args.lm_coef + output_gpt.mc_loss * args.mc_coef) / args.gradient_accumulation_steps
        if args.fp16:
